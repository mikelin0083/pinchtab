...
Reading and writing cookie payloads is HTTP-only and requires `security.allowCookies=true`. Clearing cookies remains available through the CLI and HTTP API.
